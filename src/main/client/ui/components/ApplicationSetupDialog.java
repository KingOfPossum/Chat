...
public class ApplicationSetupDialog {
    ...
    public static Optional<SetupData> showSetupDialog(String defaultIP, int defaultPort) {
        ...
        dialog.setResultConverter(dialogButton -> {
            if(dialogButton == connectButtonType) {
                return new SetupData(ipText.getText(), Integer.parseInt(portText.getText()), usernameTxt.getText(),passwordTxt.getText());
            }
            return null;
        });
    ...
    public record SetupData( String ip, int port, String userName,String password) {}
}
